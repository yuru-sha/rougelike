...
XP_REQUIREMENTS = {level: level * 10000 for level in range(1, 22)}
...
# Level up bonuses
LEVEL_UP_CONFIG = {"HP_INCREASE": 2, "STRENGTH_INCREASE": 1, "XP_MULTIPLIER": 10}
...
LOG_CONFIG = {"MAX_FILE_SIZE": 1024 * 1024, "BACKUP_COUNT": 2}  # 1MB
